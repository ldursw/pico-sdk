...
// All the default CYW43 PIN values below match Raspberry Pi Pico W, but can be overridden in a board header file

// PICO_CONFIG: CYW43_PIN_WL_DYNAMIC, flag to indicate if cyw43 SPI pins can be changed at runtime, type=bool, default=0, advanced=true, group=pico_cyw43_driver
